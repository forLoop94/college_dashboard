...
export const getDeanDepartments = createAsyncThunk(
  "department/getDeanDepartments",
  async () => {
    const token = localStorage.getItem("token");
...
export const getDepartmentStudents = createAsyncThunk(
  "department/getDepartmentStudents",
  async () => {
    const token = localStorage.getItem("token");
...
export const getDepartmentLecturers = createAsyncThunk(
  "department/getDepartmentLecturers",
  async () => {
    const token = localStorage.getItem("token");
...
export const getDepartmentCourses = createAsyncThunk(
  "department/getDepartmentCourses",
  async () => {
    const token = localStorage.getItem("token");
